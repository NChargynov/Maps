...
public class PermissionUtils {
    ...
    private static String[] PERMISSION = new String[]{Manifest.permission.ACCESS_FINE_LOCATION,
    ...
    private static void requestPermission(Activity activity) {
        ActivityCompat.requestPermissions(activity, PERMISSION, REQUEST_LOCATION);
